...
from drone_comm.msg import QuadCorners
...
class TagExtractor:
    def __init__(self, gimbal_camera_name):
        ...
        self.corners_pub = rospy.Publisher("{}/corners".format(self.node_name), QuadCorners, queue_size=1)
...
if __name__ == "__main__":
    vs_front_end = TagExtractor(argv[1])
    vs_front_end.spin()